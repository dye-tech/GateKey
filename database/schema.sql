...
--
-- Name: certificate_revocations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: crl_cache; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.gateway_connections (
    ...
    CONSTRAINT gateway_connections_user_type_check CHECK (((user_type)::text = ANY ((ARRAY['sso'::character varying, 'local'::character varying])::text[])))
);
...
CREATE TABLE public.geo_fence_rules (
    ...
    updated_at timestamp with time zone DEFAULT now(),
    ipv6_range text,
    CONSTRAINT geo_fence_rules_at_least_one_range CHECK (((ip_range IS NOT NULL) OR (ipv6_range IS NOT NULL)))
);
...
CREATE TABLE public.local_group_members (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT local_group_members_member_type_check CHECK (((member_type)::text = ANY ((ARRAY['sso'::character varying, 'local'::character varying])::text[])))
);
...
CREATE TABLE public.mesh_generated_configs (
    ...
    revoked_reason character varying(255),
    assigned_ip inet,
    is_wireguard boolean DEFAULT false NOT NULL,
    public_key text,
    preshared_key text
);
...
CREATE TABLE public.wg_mesh_peers (
    ...
    allowed_ips text[] DEFAULT ARRAY[]::text[] NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    last_seen timestamp with time zone,
    is_revoked boolean DEFAULT false NOT NULL,
...
--
-- Name: certificate_revocations certificate_revocations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: certificate_revocations certificate_revocations_serial_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crl_cache crl_cache_ca_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: crl_cache crl_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.gateway_connections
    ADD CONSTRAINT gateway_connections_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.geo_fence_global
    ADD CONSTRAINT geo_fence_global_pkey PRIMARY KEY (rule_id);
...
ALTER TABLE ONLY public.geo_fence_rules
    ADD CONSTRAINT geo_fence_rules_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.group_geo_fence_rules
    ADD CONSTRAINT group_geo_fence_rules_pkey PRIMARY KEY (group_name, rule_id);
...
ALTER TABLE ONLY public.local_group_members
    ADD CONSTRAINT local_group_members_pkey PRIMARY KEY (group_id, user_id, member_type);
...
ALTER TABLE ONLY public.local_groups
    ADD CONSTRAINT local_groups_name_key UNIQUE (name);
...
ALTER TABLE ONLY public.wg_mesh_peers
    ADD CONSTRAINT unique_wg_mesh_peer_pubkey UNIQUE (hub_id, public_key);
...
ALTER TABLE ONLY public.user_geo_fence_rules
    ADD CONSTRAINT user_geo_fence_rules_pkey PRIMARY KEY (user_id, rule_id);
...
ALTER TABLE ONLY public.wg_mesh_peers
    ADD CONSTRAINT wg_mesh_peers_pkey PRIMARY KEY (id);
...
--
-- Name: idx_certificate_revocations_ca_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_certificate_revocations_revoked_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_certificate_revocations_serial; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gateways_public_ip_v6; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gateways_vpn_subnet_v6; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_mesh_hubs_vpn_subnet_v6; Type: INDEX; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.gateway_connections
    ADD CONSTRAINT gateway_connections_gateway_id_fkey FOREIGN KEY (gateway_id) REFERENCES public.gateways(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.geo_fence_global
    ADD CONSTRAINT geo_fence_global_rule_id_fkey FOREIGN KEY (rule_id) REFERENCES public.geo_fence_rules(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.group_geo_fence_rules
    ADD CONSTRAINT group_geo_fence_rules_rule_id_fkey FOREIGN KEY (rule_id) REFERENCES public.geo_fence_rules(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.local_group_members
    ADD CONSTRAINT local_group_members_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.local_groups(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.user_geo_fence_rules
    ADD CONSTRAINT user_geo_fence_rules_rule_id_fkey FOREIGN KEY (rule_id) REFERENCES public.geo_fence_rules(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wg_mesh_peers
    ADD CONSTRAINT wg_mesh_peers_config_id_fkey FOREIGN KEY (config_id) REFERENCES public.mesh_generated_configs(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.wg_mesh_peers
    ADD CONSTRAINT wg_mesh_peers_hub_id_fkey FOREIGN KEY (hub_id) REFERENCES public.mesh_hubs(id) ON DELETE CASCADE;
