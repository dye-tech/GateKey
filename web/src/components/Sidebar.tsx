...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const navigation = [
    ...
    { name: 'Access Requests', href: '/access-requests', icon: 'jit' },
  ]
  ...
  const adminNavigationGroups = [
    {
      ...
      items: [
        ...
        { name: 'JIT Access', href: '/admin/jit-access', icon: 'jit' },
      ]
    },
    {
      label: 'Network',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Proxy Logs', href: '/admin/proxy-logs', icon: 'logs' },
      ]
    },
    {
      label: 'Diagnostics',
      items: [
        ...
        { name: 'Network Activity', href: '/admin/network-activity', icon: 'activity' },
      ]
    },
    {
      label: 'System',
