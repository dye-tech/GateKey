...
export default function AdminNetworkTools() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="card">
        <h1 className="text-2xl font-bold text-theme-primary">Network Tools</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="card">
            ...
            <select
              ...
              className="w-full max-w-md px-3 py-2 border border-theme rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
            >
          ...
          {/* Tool Configuration */}
          <div className="card">
            <h3 className="text-lg font-medium text-theme-primary mb-4">Network Diagnostic Tools</h3>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
              {/* Tool Selection */}
              <div>
                <label className="block text-sm font-medium text-theme-secondary mb-1">Tool</label>
                <select
                  value={selectedTool}
              ...
              {/* Target */}
              <div>
                <label className="block text-sm font-medium text-theme-secondary mb-1">Target</label>
                <input
                  type="text"
                  value={target}
              ...
              {selectedTool === 'nmap' && (
                <div>
                  <label className="block text-sm font-medium text-theme-secondary mb-1">Ports</label>
                  <input
                    type="text"
                    value={ports}
              ...
              {/* Location */}
              <div>
                <label className="block text-sm font-medium text-theme-secondary mb-1">Execute From</label>
                <select
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-4 text-sm">
                  ...
                  <span className="text-theme-tertiary">Duration: {toolResult.duration}</span>
                </div>
              </div>
          ...
          {/* Tool Descriptions */}
          <div className="card">
            <h3 className="text-lg font-medium text-theme-primary mb-4">Available Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {tools.map((tool) => (
                <div key={tool.name} className="p-3 bg-theme-tertiary rounded-lg">
                  <div className="font-medium text-theme-primary">{tool.name}</div>
                  <div className="text-sm text-theme-tertiary mt-1">{tool.description}</div>
