            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a
                  ...
                  download="gatekey"
                >
                  <svg className="h-8 w-8 text-gray-600 mr-3" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.504 0c-.155 0-.311.006-.466.018a8.506 8.506 0 0 0-.724.063C7.938.415 5.196 2.18 3.65 4.849c-.768 1.325-1.242 2.76-1.44 4.267-.198 1.507-.119 3.048.246 4.488a11.28 11.28 0 0 0 1.73 3.704c.843 1.127 1.887 2.112 3.112 2.914 1.226.802 2.621 1.378 4.122 1.698 1.5.32 3.073.36 4.593.116a11.63 11.63 0 0 0 4.236-1.497c1.304-.772 2.447-1.758 3.393-2.914.947-1.155 1.676-2.463 2.164-3.858.488-1.395.732-2.862.728-4.335-.004-1.473-.252-2.94-.744-4.335a11.283 11.283 0 0 0-2.172-3.858c-.95-1.156-2.1-2.142-3.408-2.914A11.627 11.627 0 0 0 15.5.513C14.523.18 13.516.006 12.504 0z"/>
                  </svg>
                  <div>
